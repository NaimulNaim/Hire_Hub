...
import {
  ...
  HomeOutlined,
  PlusSquareOutlined,
  PlusOutlined, CheckOutlined,LogoutOutlined
  ...
  render() {
    ...
    return (
      <Layout>
        ...
        >
          <div className="logo">
          {this.state.collapsed ? (<h1>HH</h1>) : (<h1>Hire Hub</h1>)}
          </div>
          ...
          <Header className="site-layout-background" style={{ padding: 0, position:'sticky', overflow: 'auto', top: 0, zIndex:9999  }}>
            ...
            <div className='flex justify-content-between'>
              ...
              <div style={{display : this.state.collapsed ? 'none' : 'inline'}}>
                <h5 className='m-2'><b>{user.usename} </b> </h5>
              </div>
              <div>
                <h3 className="mr-2" ><b>{user.username}</b></h3>
              </div>
            </div>
